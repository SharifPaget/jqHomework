...
$(document).ready(function(){
  //verifies all HTML loaded
      ...
      $("#hi-maya").on("click", function (e)
    {
      ...
      $('#style-multi').on("click", function (e) {
       e.preventDefault(); //disable the button's default behavior
      $('#para1, #para2').addClass("addBorder highlight");
            //adding mulitple classes to single element
      $('.authors').addClass('someStyling somePadding');
            //adding mulpile classes to single element
});
